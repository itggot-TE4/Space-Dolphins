...
=======
  ...
  mutations: {
    ...
    updateTeacherPassword(state, teacher) {
      // let updateTeacherIndex = state.teachers.findIndex(element => element.id == teacher.id)
      // Vue.set(state.teachers[updateTeacherIndex].password = teacher.password)
    }
>>>>>>> stuff
  },
  state: {
